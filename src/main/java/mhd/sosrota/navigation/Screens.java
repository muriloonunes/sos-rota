...
public enum Screens {
    ...
    TELA_REDEFINIR_SENHA("/mhd/sosrota/forgot_password_screen.fxml"),
    ...
    DESPACHAR("/mhd/sosrota/despachar_ambulancia_screen.fxml"),
    DETALHES("/mhd/sosrota/atendimento_detalhes_screen.fxml"),;
